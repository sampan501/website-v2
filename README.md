...
My personal website. Built using [Hugo](https://gohugo.io/) and based on the [Blogphonic](https://github.com/formspree/blogophonic-hugo) theme.

## Development

Start hugo at the root:
...
- **catalyststuff:** Logo vector created by catalyststuff - [www.freepik.com](https://www.freepik.com/vectors/logo). Licensed under [Free for commercial use WITH ATTRIBUTION license](https://www.freepik.com/terms_of_use).
- **SVG Repo:** Browse 300.000+ SVG Vectors and Icons [SVG Repo](https://www.svgrepo.com/). Licensed under [CCC0](https://www.svgrepo.com/page/licensing).
- **screenshot.rocks:** Create beautiful mobile & browser screenshots in seconds [screenshot.rocks](https://screenshot.rocks/). Licensed under [MIT](https://github.com/daveearley/screenshot.rocks/blob/master/LICENCE).
